...
var SerialTransactionExecutor = class {
  constructor({
    ...
    __privateSet4(this, _cache2, new CachingTransactionExecutor({
      ...
      cache: options.cache,
      onEffects: (effects) => __privateGet5(this, _cacheGasCoin).call(this, effects)
    }));
  }
  async applyEffects(effects) {
    return __privateGet5(this, _cache2).applyEffects(effects);
  }
...
//# sourceMappingURL=chunk-X7O7PGWG.js.map
