...
var useSignTransaction_exports = {};
__export(useSignTransaction_exports, {
  useSignTransaction: () => useSignTransaction
});
module.exports = __toCommonJS(useSignTransaction_exports);
...
function useSignTransaction({
  ...
  return (0, import_react_query2.useMutation)({
    ...
    mutationFn: async ({ transaction, ...signTransactionArgs }) => {
      ...
      const { bytes, signature } = await (0, import_wallet_standard.signTransaction)(currentWallet, {
        ...signTransactionArgs,
        transaction: {
          toJSON: async () => {
